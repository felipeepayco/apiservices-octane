...
class SetShippingInfoShoppingCartValidation extends HelperPago
{
    ...
    public function handle(Request $request)
    {
        ...
        if (isset($data['countryName'])) {
            $arr_respuesta['countryName'] = $data['countryName'];
        } else {
            $arr_respuesta['countryName'] = "";
        }

        if (isset($data['countryCode'])) {
            $arr_respuesta['countryCode'] = $data['countryCode'];
        } else {
            $arr_respuesta['countryCode'] = "57";
        }
        ...
        if (isset($data['detailTotal']) && is_array($data['detailTotal'])) {
            $arr_respuesta['detailTotal'] = $data['detailTotal'];
        } else {
            $arr_respuesta['detailTotal'] = [];
        }
