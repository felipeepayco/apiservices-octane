...
class UpdateBuyerValidation
{
    ...
    public function validation(Request $request)
    {
        $request->merge([
            ...
            'comprador_id' => $request->input('buyerId')
        ]);

        $validator = Validator::make($request->all(), [
            'comprador_id' => 'required||digits_between:1,10|numeric|gt:0',
            ...
            'comprador_id.required' => 'El campo comprador_id es obligatorio.',
            'comprador_id.digits_between' => 'El campo comprador_id debe tener entre 1 y 10 digitos',
            'comprador_id.gt' => 'El campo comprador_id debe ser mayor a 0',
            'comprador_id.numeric' => 'El campo comprador_id debe ser numerico',
        ...
        $existingBuyer = $this->bblBuyerRepository->findBuyerByDocumentAndClientId($request->comprador_id);
