...
use App\Http\Validation\SMTPValidateEmail\Exceptions\Exception as Exception;
use App\Http\Validation\SMTPValidateEmail\Exceptions\Timeout as TimeoutException;
use App\Http\Validation\SMTPValidateEmail\Exceptions\NoTimeout as NoTimeoutException;
use App\Http\Validation\SMTPValidateEmail\Exceptions\NoConnection as NoConnectionException;
use App\Http\Validation\SMTPValidateEmail\Exceptions\UnexpectedResponse as UnexpectedResponseException;
use App\Http\Validation\SMTPValidateEmail\Exceptions\NoHelo as NoHeloException;
use App\Http\Validation\SMTPValidateEmail\Exceptions\NoMailFrom as NoMailFromException;
use App\Http\Validation\SMTPValidateEmail\Exceptions\NoResponse as NoResponseException;
use App\Http\Validation\SMTPValidateEmail\Exceptions\SendFailed as SendFailedException;
