...
use App\Events\ValidationGeneralCatalogueProductUpdateEvent;
...
class ValidationGeneralCatalogueProductUpdateListener extends HelperPago {
     ...
     * @return void
     */
    public function handle(ValidationGeneralCatalogueProductUpdateEvent $event)
    {
        ...
        if(isset($catalogueId)){
            ...
            if (!$vclientId) {
                ...
                $arr_respuesta['catalogueId'] = $clientId;
            }
        }else{
            $validate->setError(500, "field catalogueId required");
        }
...
//            }
        ...
        if( $validate->totalerrors > 0 ){
            ...
            //dd($response);
            $this->saveLog(2,$clientId, '', $response,'catalogue_product_update');
