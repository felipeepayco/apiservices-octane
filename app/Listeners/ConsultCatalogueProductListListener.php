...
class ConsultCatalogueProductListListener extends HelperPago {
     ...
     * @return void
     */
    public function handle(ConsultCatalogueProductListEvent $event)
    {
        try{
            ...
            $sellList= CatalogoProductos::where("cliente_id",$clientId)
                ->where("estado",">=",1);
            ...
            $cobros=$sellList->addSelect("id")
                ...
                ->orderBy("titulo","asc")->paginate(50);
