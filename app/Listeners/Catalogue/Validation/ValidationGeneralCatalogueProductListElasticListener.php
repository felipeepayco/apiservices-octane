...
class ValidationGeneralCatalogueProductListElasticListener extends HelperPago {
     ...
     * @return void
     */
    public function handle(ValidationGeneralCatalogueProductListElasticEvent $event)
    {
