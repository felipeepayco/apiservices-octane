...
class ValidationGeneralCatalogueProductDeleteElasticListener extends HelperPago
{
     ...
     *
     */
    public function handle(ValidationGeneralCatalogueProductDeleteElasticEvent $event)
    {
