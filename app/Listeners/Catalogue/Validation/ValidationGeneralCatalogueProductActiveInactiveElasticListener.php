...
class ValidationGeneralCatalogueProductActiveInactiveElasticListener extends HelperPago
{
     ...
     *
     */
    public function handle(ValidationGeneralCatalogueProductActiveInactiveElasticEvent $event)
    {
        ...
        if ($validate->totalerrors > 0) {
            ...
            //dd($response);
            $this->saveLog(2,$clientId, '', $response, 'consult_active_inactive_product');
