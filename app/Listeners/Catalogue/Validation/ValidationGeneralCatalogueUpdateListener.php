...
class ValidationGeneralCatalogueUpdateListener extends HelperPago
{
    const empty = 'empty';

    /**
     * ValidationGeneralCatalogueUpdateEvent constructor.
    ...
    /**
     * @param ValidationGeneralCatalogueUpdateEvent $event
     * @return array
     * @throws \Exception
     */
    public function handle(ValidationGeneralCatalogueUpdateEvent $event)
    {
        ...
        if ($data["ownDomain"]) {
            ...
            $search->addQuery(new TermQuery("id", $data["id"]), BoolQuery::MUST_NOT);
