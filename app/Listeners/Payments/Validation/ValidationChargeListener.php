...
class ValidationChargeListener extends HelperPago
{

    /**
     * ValidationChargeListener constructor.
    ...
    /**
     * @param ValidationChargeEvent $event
     * @return array
     */
    public function handle(ValidationChargeEvent $event)
    {
